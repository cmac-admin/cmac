...
export const metadata: Metadata = {
  title: "Old Colors",
  description: "Legacy CMAC palette preview for board review and brand comparison.",
};
...
export default function OldColorsPage() {
  return (
    <main className="home-page legacy-homepage">
      <div className="legacy-homepage__banner">OLD COLORS</div>

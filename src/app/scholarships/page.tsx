    ...
    <main className="subpage">
      ...
      <section className="content-card scholarship-block">
        ...
        <ul className="info-list">
          ...
          <li>Selected student(s) receive a $500 scholarship.</li>
          <li>
            Winners must submit a college or university acceptance letter for
            fund release.
          </li>
        </ul>
      ...
      <section className="content-card scholarship-block">
        ...
        <ul className="info-list">
          <li>Application due by Saturday, May 1, 2027.</li>
          <li>Selected student(s) receive a $100 scholarship.</li>
          <li>
            Open to students at Boyle Road, Terryville Road, JFK Middle School,
